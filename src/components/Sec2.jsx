            ...
            <div className="flex">
                ...
                <div className="flex r pad__join" data-aos='fade-up'>
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon= "fa-solid fa-paint-roller" className="icos" />
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-earth-asia" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-clipboard" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-bullhorn" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-microphone-lines" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-briefcase" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-user-group" className="icos" />
                        <div className="card__sw">
                    ...
                    <div className="flex r pd-20">
                        <FontAwesomeIcon icon="fa-solid fa-music" className="icos" />
                        <div className="card__sw">
