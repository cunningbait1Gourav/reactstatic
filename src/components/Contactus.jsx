...
const ContactUs = () => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    send("service_k6r053b", "template_ews6eyj", toSend, "Kt2aPFGYy6fJBu5RR")
      .then((response) => {
    ...
    <div className="s-contact" id="contactUs">
      <div className="overlay">
        ...
        <div className="flex r">
          <h1 className="display2" data-aos="fade-up">
            Give suggestions or just say hello
          </h1>
        </div>
          ...
          <div className="contact-primary">
            ...
            <form className="contactForm" onSubmit={onSubmit}>
              <fieldset>
                ...
                <div className="form-field">
                  <button className="full-width btn--primary" type="submit">
                    Submit
                  </button>
          ...
          <div className="contact-secondary">
            <div className="contact-info">
              <div className="contact-info">
                ...
                <div className="cinfo">
                  <h5>Email Us At</h5>
                  <a href="mailto:rotosindri@gmail.com" target="_blank">
                    <p>
                      rotosindri@gmail.com
                      <br />
                    </p>
                  </a>
                </div>
